    ...
    <MapProvider>
      <div className='flex h-full w-full flex-col-reverse bg-white shadow-2xl lg:flex-row'>
        ...
        <main className='flex basis-full flex-col overflow-y-hidden lg:flex-row'>
          <div
            className={`sm-md:overflow-y-hidden relative z-20 flex w-full shrink-0 flex-col bg-white lg:flex lg:w-96 lg:min-w-96 lg:basis-auto ${
          ...
          >
            <div
              className={`basis-full ${
                pathname.includes('detail') && 'hidden lg:block'
              }`}
            >
              <SearchCategory />
              <SearchAgainButton />
