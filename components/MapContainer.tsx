...
import SearchCategory from './common/place/search/SearchCategory';
import SearchAgainButton from './common/place/search/SearchAgainButton';
import { usePathname } from 'next/navigation';
import CurrLocationButton from './common/Button/CurrLocationButton';
